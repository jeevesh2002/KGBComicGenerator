...
def gpt_prompt_and_eval(input_places, input_probs, tags, entropy_specifier, initial_state):
    ...
    prompt_init = "Kodex cannot remember how he got here. Tell the story of him trying to remember how he got here in 3 steps and be descriptive. "
    prompt_init += "He only remembers a few things, and considers each possible place one at a time. Use grandiose language. Embelish everything and paint a picture with words. Make the descriptions drip with imagery. Make the image ultra high resoulution. Give the detailed image dont leave any details "
